...
@Component
public class TimeSeriesMetricsProcessor implements DataProcessor {

    private MetricsEndpointProcessor metricsEndpointPoller;
    private ClientAppSnapshotRepository clientAppSnapshotRepository;


    private static final Logger LOGGER = LoggerFactory.getLogger(TimeSeriesMetricsProcessor.class);

    @Autowired
    public TimeSeriesMetricsProcessor(MetricsEndpointProcessor metricsEndpointPoller,
